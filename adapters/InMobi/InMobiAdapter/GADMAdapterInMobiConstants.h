...
static NSString *const GADMAdapterInMobiVersion = @"10.5.4.0";
...
/// Key for the InMobi request parameters adpter version.
static NSString *const GADMAdapterInMobiRequestParametersAdapterVersionKey = @"tp-ver";
